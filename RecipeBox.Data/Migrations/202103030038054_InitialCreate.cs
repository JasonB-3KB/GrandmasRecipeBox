    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        RecipeContentId = c.Int(nullable: false),
                        OwnerId = c.Guid(nullable: false),
                ...
                .ForeignKey("dbo.RecipeContent", t => t.RecipeContentId, cascadeDelete: true)
                .ForeignKey("dbo.Source", t => t.SourceId, cascadeDelete: true)
                .Index(t => t.RecipeContentId)
                .Index(t => t.SourceId);
            ...
            CreateTable(
                ...
                c => new
                    {
                        RecipeContentId = c.Int(nullable: false, identity: true),
                        IngredientId = c.Int(nullable: false),
                        IngredientQuantity = c.String(),
                    })
                .PrimaryKey(t => t.RecipeContentId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Recipe", "RecipeContentId", "dbo.RecipeContent");
            DropForeignKey("dbo.RecipeContent", "IngredientId", "dbo.Ingredient");
            DropIndex("dbo.IdentityUserLogin", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserClaim", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "ApplicationUser_Id" });
            DropIndex("dbo.IdentityUserRole", new[] { "IdentityRole_Id" });
            DropIndex("dbo.RecipeContent", new[] { "IngredientId" });
            DropIndex("dbo.Recipe", new[] { "SourceId" });
            DropIndex("dbo.Recipe", new[] { "RecipeContentId" });
